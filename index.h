/* 
    Header de index que serão utilizadas para a construção e implementação da Árvore B. Alguns padrões foram seguidos
    a partir do "index-exemplo" fornecido para o auxílio da execução do trabalho, por isso, partes do código estão em inglês.
*/
...
// Contador de chaves, o booleano "isLeaf" e rrn da propria pagina
...
// Recebe como argumento um arquivo "de indexes" vazios ou contendo uma btree
